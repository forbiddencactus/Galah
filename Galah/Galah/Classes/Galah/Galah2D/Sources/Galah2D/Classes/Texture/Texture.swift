...
public class Texture
{
    ...
    public let Size: Rect<Int>; //The size of this texture, in width and height.
    
    public init(_ pointerToTexture: UnsafeMutableRawPointer,_ size: Rect<Int>,_ pixelFormat: Int)
    {
